...
USE MPL_ARG_MOD
USE MPL_HEAP_MOD, ONLY : MPL_HEAP, USE_MPL_HEAP_FOR_RECEIVE_BUFFER, USE_MPL_HEAP_FOR_SEND_BUFFER
...
SELECT CASE (USE_MPL_HEAP_FOR_REVEIVE_BUFFER_STATUS)
  CASE(0)
    ...
    USE_MPL_HEAP_FOR_RECEIVE_BUFFER=.TRUE.
  CASE DEFAULT
    PRINT*,"DEBUG: USING STANDARD ALLOCATBLE TABLE FOR COMBUFR RECEIVE BUFFER"
    USE_MPL_HEAP_FOR_RECEIVE_BUFFER=.FALSE.
END SELECT
