...
USE MPL_ARG_MOD
USE MPL_HEAP_MOD, ONLY : MPL_HEAP, USE_MPL_HEAP_FOR_REVEIVE_BUFFER, USE_MPL_HEAP_FOR_SEND_BUFFER
...
INTEGER            :: USE_MPL_HEAP_FOR_SEND_BUFFER_STATUS
...
CALL GET_ENVIRONMENT_VARIABLE('USE_MPL_HEAP_FOR_SEND_BUFFER',status=USE_MPL_HEAP_FOR_SEND_BUFFER_STATUS)

SELECT CASE (USE_MPL_HEAP_FOR_SEND_BUFFER_STATUS)
  CASE(0)
    PRINT*,"DEBUG: USING MPL_HEAP BUFFER FOR COMBUFS SEND BUFFER"
    USE_MPL_HEAP_FOR_SEND_BUFFER=.TRUE.
  CASE DEFAULT
    PRINT*,"DEBUG: USING STANDARD ALLOCATBLE TABLE FOR COMBUFS SEND BUFFER"
    USE_MPL_HEAP_FOR_SEND_BUFFER=.FALSE.
END SELECT
